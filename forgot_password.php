        ...
        <div class="col-md-4" style="background-color: #D2D1D1; border-radius:15px;">
          ...
          <form role="form" method="POST">
            ...
            <?php if (isset($message_success)) {
              ...
              <button type="submit" class="btn btn-primary pull-right" name="submit" style="display: block; width: 100%; background-color: #b73333;">Recover Password</button>
              <br><br>
