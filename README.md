...
1. Get a free API Key at Paypal
   ```sh
   git clone https://github.com/RudoChitsa/WebFlix.git
   ```
...
Your Name - Rudo Chitsa - info@webflix.digital

Project Link: https://github.com/RudoChitsa/WebFlix
