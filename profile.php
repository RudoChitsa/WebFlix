...
<div class="settingsContainer column">
    ...
    <div class="formSection">
        ...
        <form method="POST">
            ...
            <input type="text" style="color: #313639;" name="firstName" placeholder="First name" value="<?php echo $firstName; ?>">
            <input type="text" style="color: #313639;" name="lastName" placeholder="Last name" value="<?php echo $lastName; ?>">
    ...
    <ul class="navLinks">
        ...
        <li><a href="legal.php#legal">Legal Notices</a></li>
        <li><a href="profile.php">Account</a></li>
        <li><a href="contact.php#terms">Terms of Use</a></li>
